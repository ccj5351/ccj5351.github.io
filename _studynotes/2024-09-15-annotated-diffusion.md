...
<p align="center">
    <img src="{% link files/78_annotated-diffusion/diffusion_figure.png %}" width="600" />
</p>
...
We can sample from this distribution to get an image, $\mathbf{x}_0 \sim q(\mathbf{x}_0)$. We define the forward diffusion process $q(\mathbf{x}_t | \mathbf{x}_{t-1})$ which adds Gaussian noise at each time step $t$, according to a known variance schedule $ 0 < \beta_1 < \beta_2 < ... < \beta_T < 1 $ as
...
<p align="center">
    <img src="{% link files/78_annotated-diffusion/training.png %}" width="400" />
</p>
...
<p align="center">
    <img src="{% link files/78_annotated-diffusion/unet_architecture.jpg %}" width="600" />
</p>
...
<p align="center">
    <img src="{% link files/78_annotated-diffusion/linear-attention.png %}" width="700" />
</p>
...
```
<p align="center">
<img src="{% link files/78_annotated-diffusion/output_cats.jpeg %}" width="400" />
</p>
...
<p align="center">
<img src="{% link files/78_annotated-diffusion/output_cats_verify.png %}" width="100" />
</p>
...
<p align="center">
<img src="{% link files/78_annotated-diffusion/output_cats_noisy.png %}" width="100" />
</p>
...
<p align="center">
<img src="{% link files/78_annotated-diffusion/output_cats_noisy_multiple.png %}" width="800" />
</p>
...
<p align="center">
<img src="{% link files/78_annotated-diffusion/sampling.png %}" width="500" />
</p>
...
<p align="center">
<img src="{% link files/78_annotated-diffusion/output.png %}" width="300" >
</p>
...
<p align="center">
<img src="{% link files/78_annotated-diffusion/diffusion-sweater.gif %}" width="300" />
</p>
